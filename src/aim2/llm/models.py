...
def load_local_model_via_outlinesVLLM(model_name="kosbu/Llama-3.3-70B-Instruct-AWQ", max_model_len=2500, quantization="awq_marlin"):
    ...
    try:
        model = vllm.LLM(
            ...
            # max_num_seqs=64,                        # 64 for 20 core cpu. adjust based on your cpu cores
            max_num_batched_tokens=4096*8,          # Defaults to 16k. This is for batching multiple requests. adjust based on your gpu memory

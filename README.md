...
python run.py
```
3. The output will be in `output/` folder. The output files will be in JSON format containing entities. Each object has entities under specific labels, and spans.
```
{
	"compounds": [
		{
	...
	"pathways": [
		{
			...
			"ontology_id": "PWY-5405",
			"normalized_name": "superpathway of betalain biosynthesis",
			"score": 0.8249524831771851
		}, 
		{
			... more pathways ...
		}
